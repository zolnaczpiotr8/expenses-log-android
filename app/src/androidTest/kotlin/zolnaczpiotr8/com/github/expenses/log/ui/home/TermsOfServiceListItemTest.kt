...
class TermsOfServiceListItemTest {

  @get:Rule val composeTestRule = createAndroidComposeRule<ComponentActivity>()

  @Test
  fun onClickLabel() {
    composeTestRule.setContent { TermsOfServiceListItem {} }

    composeTestRule
        .onNode(hasTextExactly(composeTestRule.activity.getString(R.string.terms_of_service)))
        .assertHasOnClickLabel(composeTestRule.activity.getString(R.string.navigate_action_label))
  }
}
